...
class ImageData extends StatelessWidget {
  final String _icon;
  final double? _width; // 여기 보다시피 한번 값이 들어오면 그걸로 고정되도록 final 키워드를 사용했다.
  ImageData({Key? key, required String icon, double width = 55}) : _icon = icon, _width = width, super(key: key);
